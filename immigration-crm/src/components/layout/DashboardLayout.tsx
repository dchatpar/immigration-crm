...
export default function DashboardLayout({ children }: DashboardLayoutProps) {
  ...
  const navigation = [
    ...
    { name: 'Document Vault', href: '/dashboard/vault', icon: Folder },
      ...
      <div className="flex flex-col lg:pl-64">
        ...
        <div className="sticky top-0 z-10 flex h-16 flex-shrink-0 bg-white shadow-sm border-b border-gray-200">
          ...
          <div className="flex flex-1 justify-between px-4">
            ...
            <div className="ml-4 flex items-center lg:ml-6 gap-3">
              <button
                type="button"
                ...
                {stats.map((stat) => (
                  ...
                  >
                    <div className="p-5">
                      <div className="flex items-center">
                        <div className="flex-shrink-0">
                          <div className={`h-8 w-8 rounded-full flex items-center justify-center ${stat.changeType === 'positive' ? 'bg-green-100 text-green-600' : 'bg-red-100 text-red-600'}`}>
                            {stat.change}
                          </div>
                        </div>
